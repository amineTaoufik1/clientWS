 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://example.org/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://example.org/", "BanqueWS");
